 ...
 */
public class E16_Async implements SchemaConstants {

    /** Logger for the class. */
    private static Logger LOGGER = LoggerFactory.getLogger(E16_Async.class);
    ...
    private static CompletableFuture< Optional < UserDto > > findUserByIdAsync(String email) {
        return session.executeAsync(stmtFindUser.bind(email))
                      .thenApply(E16_Async::mapUserDtoRow)
                      .toCompletableFuture();
    }
