...
import static com.datastax.samples.schema.SchemaUtils.*;
 ...
 * );
 */
public class E19_LightweightTransactions implements SchemaConstants {

    /** Logger for the class. */
    private static Logger LOGGER = LoggerFactory.getLogger(E19_LightweightTransactions.class);
